...
class SavingsScreen extends ConsumerWidget {
  ...
  Widget _buildSummaryHeader(
      BuildContext context, AsyncValue<double> totalAsync) {
                ...
                return Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        const Text("Progreso Mensual",
                            style:
                                TextStyle(color: Colors.white70, fontSize: 12)),
                        Text("${data.executedPlans}/${data.totalPlans} Cuotas",
                            style: const TextStyle(
                                color: Colors.white,
                                fontWeight: FontWeight.bold,
                                fontSize: 12)),
                    ...
                    Stack(
                      children: [
                        ...
                        if (isOverAchieved)
                          FractionallySizedBox(
                            widthFactor:
                                displayProgress, // Ocupa todo el ancho base
                            child: Align(
                              alignment:
                                  Alignment.centerRight, // Se alinea al final
                              child: Container(
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text("\$${data.executed.toStringAsFixed(0)}",
                            style: const TextStyle(
                                color: Colors.white,
                                fontWeight: FontWeight.bold)),
                        Text("Meta: \$${data.expected.toStringAsFixed(0)}",
                            style: const TextStyle(
